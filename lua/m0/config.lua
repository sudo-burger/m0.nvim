  ...
  defaults = {
    ...
    providers = {
      ...
      ['groq'] = {
        ...
        temperature = 0.7,
        models = {
          { name = 'distil-whisper-large-v3-en', max_tokens = 448 },
          { name = 'gemma-7b-it', max_tokens = 8192 },
          { name = 'gemma2-9b-it', max_tokens = 8192 },
          { name = 'llama-3.1-70b-versatile', max_tokens = 32768 },
          { name = 'llama-3.1-8b-instant', max_tokens = 131072 },
          { name = 'llama-3.2-11b-text-preview', max_tokens = 8192 },
          { name = 'llama-3.2-11b-vision-preview', max_tokens = 8192 },
          { name = 'llama-3.2-1b-preview', max_tokens = 8192 },
          { name = 'llama-3.2-3b-preview', max_tokens = 8192 },
          { name = 'llama-3.2-90b-text-preview', max_tokens = 8192 },
          { name = 'llama-3.2-90b-vision-preview', max_tokens = 8192 },
          { name = 'llama-guard-3-8b', max_tokens = 8192 },
          { name = 'llama3-70b-8192', max_tokens = 8192 },
          { name = 'llama3-8b-8192', max_tokens = 8192 },
          { name = 'llama3-groq-70b-8192-tool-use-preview', max_tokens = 8192 },
          { name = 'llama3-groq-8b-8192-tool-use-preview', max_tokens = 8192 },
          { name = 'llava-v1.5-7b-4096-preview', max_tokens = 4096 },
          { name = 'mixtral-8x7b-32768', max_tokens = 32768 },
          { name = 'whisper-large-v3', max_tokens = 448 },
          { name = 'whisper-large-v3-turbo', max_tokens = 448 },
        },
      },
    },
    prompts = {
